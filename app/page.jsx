    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <p className="text-lg md:text-xl text-orange-800 mb-8">
          Capture your thoughts, track your moods, and relect on your journey in a beautiful, secure space.
        </p>
      ...
      >
        {features.map((feature, index) => (
          <Card key={index} className="hover:shadow-lg border-amber-800/20 ">
